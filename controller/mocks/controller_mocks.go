...
// ExtractDataFromBTCCSVRows mocks base method.
func (m *MockDataGetter) ExtractDataFromBTCCSVRows(arg0 int, arg1 [][]string) (model.CryptoRecordValues, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ExtractDataFromBTCCSVRows", arg0, arg1)
	ret0, _ := ret[0].(model.CryptoRecordValues)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ExtractDataFromBTCCSVRows indicates an expected call of ExtractDataFromBTCCSVRows.
func (mr *MockDataGetterMockRecorder) ExtractDataFromBTCCSVRows(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExtractDataFromBTCCSVRows", reflect.TypeOf((*MockDataGetter)(nil).ExtractDataFromBTCCSVRows), arg0, arg1)
}

...
func GetRouter() (router *mux.Router) {
	...
	dataGrapherService := controller.NewDataGrapher()
	serviceHandler := controller.NewUseCasesHandler(dataService, graphService, converterService, workerPoolService, dataGrapherService)
